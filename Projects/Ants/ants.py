...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if isinstance(insect, QueenAnt) and insect.identity:
                self.ant = insect
            elif insect.is_ant:
...
class ThrowerAnt(Ant):
    ...
    min_range = None
    max_range = None
    def __init__(self, armor = 1, damage = 1):
    ...
    def nearest_bee(self, hive):
        ...
        if self.min_range:
            ...
            while counter <= self.min_range:
                place_to_check, counter = place_to_check.entrance, counter + 1
        elif self.max_range:
            counter = 0
            while counter <= self.max_range:
                if random_or_none(place_to_check.bees):
                    return random_or_none(place_to_check.bees)
                else:
                    counter += 1
                    place_to_check = place_to_check.entrance
            return None
        while place_to_check is not hive:
            if random_or_none(place_to_check.bees):
                return random_or_none(place_to_check.bees)
            place_to_check = place_to_check.entrance
        return None
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        """
        # BEGIN Problem 4
        bees_list = [x for x in self.place.bees]
    ...
    def action(self, colony):
        ...
        if not self.identity:
            ...
            while place_to_check:
                if isinstance(place_to_check.ant, BodyguardAnt) and place_to_check.ant.ant:
                    if place_to_check.ant.ant not in QueenAnt.doubled_damage:
                        place_to_check.ant.ant.damage *= 2
                        QueenAnt.doubled_damage += [place_to_check.ant.ant]
                if place_to_check.ant and place_to_check.ant not in QueenAnt.doubled_damage:
                    place_to_check.ant.damage *= 2
                    QueenAnt.doubled_damage += [place_to_check.ant]
...
class SlowThrower(ThrowerAnt):
    ...
    food_cost = 4
    # END Problem EC
    def __init__(self,armor = 1, damage = None):
        ThrowerAnt.__init__(self,armor,damage)
